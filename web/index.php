...
<div class="wrap">
  ...
  <section id="bankBox" class="<?= $loggedIn ? '' : 'hidden' ?>">
    ...
    <div class="card" style="margin-top:18px">
      ...
      <p class="muted small">Card status is managed by the central bank computer.</p>
    </div>
  </section>
</div>
<script>
